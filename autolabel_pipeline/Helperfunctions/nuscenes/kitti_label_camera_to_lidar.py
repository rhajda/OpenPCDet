...
if __name__ == "__main__":
    root_path = "/home/data/converted/waymo_mmdet_convert/kitti_format/training"
    data_source_path = os.path.join(root_path, "label_debug")
    data_target_path = os.path.join(root_path, "label_debug_transformed")
    calib_path = os.path.join(root_path, "calib")

    os.makedirs(data_target_path, exist_ok=True)

    convert_to_lidar(data_source_path, data_target_path, calib_path)
