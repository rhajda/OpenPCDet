...
- python convert_nuscenes_to_kitti.py nuscenes_gt_to_kitti --nusc_kitti_dir ~/nusc_kitti
- python convert_nuscenes_to_kitti.py render_kitti --nusc_kitti_dir ~/nusc_kitti --render_2d False
- python convert_nuscenes_to_kitti.py kitti_res_to_nuscenes --nusc_kitti_dir ~/nusc_kitti
...
class KittiConverter:
    def __init__(self,
        ...
        self.nusc = NuScenes(version=nusc_version, dataroot='/home/data/nuscenes')
