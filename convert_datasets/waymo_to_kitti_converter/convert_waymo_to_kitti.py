...
# Function to convert dataset from Waymo SDC to Kitti reference camera coordinate system
# https://github.com/caizhongang/waymo_kitti_converter but adapted in https://mmdetection3d.readthedocs.io/en/v0.15.0/datasets/waymo_det.html
